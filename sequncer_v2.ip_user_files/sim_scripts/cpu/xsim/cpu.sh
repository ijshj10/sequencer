...
elaborate()
{
  xelab --relax --debug typical --mt auto -L microblaze_v10_0_4 -L xil_defaultlib -L lib_cdc_v1_0_2 -L proc_sys_reset_v5_0_12 -L lmb_v10_v3_0_9 -L lmb_bram_if_cntlr_v4_0_13 -L blk_mem_gen_v8_4_0 -L iomodule_v3_1_2 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpu xil_defaultlib.cpu xil_defaultlib.glbl -log elaborate.log
}
